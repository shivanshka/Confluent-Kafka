...
FILE_PATH = "G:\Shivansh\iNeuron\Jupyter\Live_Classes\Big Data\Class 5\confluent-kafka-main\cardekho_dataset.csv"
columns=['car_name', 'brand', 'model', 'vehicle_age', 'km_driven', 'seller_type',
       'fuel_type', 'transmission_type', 'mileage', 'engine', 'max_power',
       'seats', 'selling_price']

API_KEY = '5YAFPLEXZQMWRIIW'
ENDPOINT_SCHEMA_URL  = 'https://pkc-l7pr2.ap-south-1.aws.confluent.cloud:443'
API_SECRET_KEY = 'TdXkdoi2a/SLT64jkTgjfUvObKLE4K2d9gbdpwGm+H/QD+PwXhs/6K2zpoxAXG+8'
BOOTSTRAP_SERVER = 'pkc-l7pr2.ap-south-1.aws.confluent.cloud:9092'
SECURITY_PROTOCOL = 'SASL_SSL'
SSL_MACHENISM = 'PLAIN'
SCHEMA_REGISTRY_API_KEY = 'HDIIMIB333WOYEBX'
SCHEMA_REGISTRY_API_SECRET = 'gCbGGk67sI+eukIrym4nXfOHsE8agKLMARLYr2x3tE/FG7YKc1JcThRKIgvFBnRY'
